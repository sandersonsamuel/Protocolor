...
function Landing (){
    ...
    return(
        <div className="flex conteiner flex-col items-center bg-gradient-to-br from-white to-yellow-100">
                ...
                <h1 className="sm:text-9xl sm:mt-0 mt-5 text-5xl tracking-tight font-semibold hover:tracking-wider transition-all duration-500 cursor-pointer">Protocolor</h1>
        </div>
    )
}
